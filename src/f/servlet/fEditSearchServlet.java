...
@WebServlet("/fEditSearchServlet")
public class fEditSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// パラメータの解析
			String action = request.getParameter("editSearch");
			// モデルのDAOを生成
			...
			if(action == null || action.length() == 0) {
				...
				gotoPage(request,response,"/WEB-INF/fEditSearch.jsp");
